...
import ed.maevski.hwwach.ui.navflow.mainflow.addasset.AddAssetScreen
import ed.maevski.hwwach.ui.navflow.mainflow.addasset.AddAssetScreenEvent
import ed.maevski.hwwach.ui.navflow.mainflow.addasset.AddAssetScreenViewModel
import ed.maevski.hwwach.ui.navflow.mainflow.assetdetail.AssetDetailScreen
import ed.maevski.hwwach.ui.navflow.mainflow.assetdetail.AssetDetailScreenEvent
import ed.maevski.hwwach.ui.navflow.mainflow.assetdetail.AssetDetailScreenViewModel
import ed.maevski.hwwach.ui.navflow.mainflow.camera.CameraEvent
import ed.maevski.hwwach.ui.navflow.mainflow.camera.CameraScreen
import ed.maevski.hwwach.ui.navflow.mainflow.camera.CameraViewModel
import ed.maevski.hwwach.ui.navflow.mainflow.changepasswordscreen.ChangePasswordEvent
import ed.maevski.hwwach.ui.navflow.mainflow.changepasswordscreen.ChangePasswordScreen
import ed.maevski.hwwach.ui.navflow.mainflow.changepasswordscreen.ChangePasswordViewModel
import ed.maevski.hwwach.ui.navflow.mainflow.fullimage.FullImageScreen
import ed.maevski.hwwach.ui.navflow.mainflow.fullimage.FullImageScreenEvent
import ed.maevski.hwwach.ui.navflow.mainflow.fullimage.FullImageScreenViewModel
import ed.maevski.hwwach.ui.navflow.mainflow.mainscreen.InnerMainFlowNavigation
import ed.maevski.hwwach.ui.navflow.mainflow.mainscreen.MainScreen
import ed.maevski.hwwach.ui.navflow.mainflow.mainscreen.MainScreenEvent
import ed.maevski.hwwach.ui.navflow.mainflow.mainscreen.MainScreenViewModel
...
class MainFlowNavigation(
        ...
        with(builder) {
            ...
            composable(Routes.MainScreen.route) {
                ...
                val innerMainFlowNavigation = InnerMainFlowNavigation(
                    ...
                    onNavigateToCamera = {
                        navController.navigate("MainFlowNavigator.CameraScreen")
                    },
                    onLogout = {
            ...
            composable(Routes.CameraScreen.route) {
                ...
                LaunchedEffect(viewModel.events, lifecycleOwner.lifecycle) {
                    lifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                        viewModel.events.collect { event ->
                            when (event) {
                                CameraEvent.NavigateBack -> navController.popBackStack()
                            }
                        }
                    }
                }
    ...
    sealed class Routes(val route: String) {
        ...
        data object CameraScreen : Routes(route = "MainFlowNavigator.CameraScreen")
    }
}