package ed.maevski.hwwach.ui.navflow.startflow
...
import ed.maevski.hwwach.ui.navflow.startflow.authscreen.AuthScreen
import ed.maevski.hwwach.ui.navflow.startflow.authscreen.AuthScreenEvent
import ed.maevski.hwwach.ui.navflow.startflow.authscreen.AuthScreenViewModel
import ed.maevski.hwwach.ui.navflow.startflow.changetemppasswordscreen.ChangeTempPasswordEvent
import ed.maevski.hwwach.ui.navflow.startflow.changetemppasswordscreen.ChangeTempPasswordScreen
import ed.maevski.hwwach.ui.navflow.startflow.changetemppasswordscreen.ChangeTempPasswordViewModel
import ed.maevski.hwwach.ui.navflow.startflow.forgotpasswordscreen.ForgotPasswordEvent
import ed.maevski.hwwach.ui.navflow.startflow.forgotpasswordscreen.ForgotPasswordScreen
import ed.maevski.hwwach.ui.navflow.startflow.forgotpasswordscreen.ForgotPasswordViewModel
import ed.maevski.hwwach.ui.navflow.startflow.privacypolicyscreen.PrivacyPolicyScreen
import ed.maevski.hwwach.ui.navflow.startflow.regscreen.RegScreen
import ed.maevski.hwwach.ui.navflow.startflow.regscreen.RegScreenEvent
import ed.maevski.hwwach.ui.navflow.startflow.regscreen.RegScreenViewModel
import ed.maevski.hwwach.ui.navflow.startflow.splashscreen.SplashScreen
import ed.maevski.hwwach.ui.navflow.startflow.splashscreen.SplashScreenEvent
import ed.maevski.hwwach.ui.navflow.startflow.splashscreen.SplashScreenViewModel
...
class StartFlowNavigation(
                    ...
                    lifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                        viewModel.events.collect { event ->
                            when (event) {
                                ...
                                AuthScreenEvent.NavigateToPrivacyPolicy -> {
                    ...
                    lifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                        viewModel.events.collect { event ->
                            when (event) {
                                ...
                                RegScreenEvent.NavigateToPrivacyPolicy -> {
                                    navController.navigate(Routes.PrivacyPolicyScreen.route)
                                }
    ...
    sealed class Routes(val route: String) {
        ...
        data object PrivacyPolicyScreen : Routes("StartFlowNavigator.PrivacyPolicyScreen")
    }
}