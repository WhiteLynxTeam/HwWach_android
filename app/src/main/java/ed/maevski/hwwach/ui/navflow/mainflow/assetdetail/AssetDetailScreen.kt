    ...
    Card(
        ...
        Column(
            ...
            val statusDisplay = when (asset.assetStatus) {
                ed.maevski.hwwach.domain.models.AssetStatusEnum.ACTIVE -> "В эксплуатации"
                ed.maevski.hwwach.domain.models.AssetStatusEnum.INACTIVE -> "Не используется"
                ed.maevski.hwwach.domain.models.AssetStatusEnum.MAINTENANCE -> "На обслуживании"
                ed.maevski.hwwach.domain.models.AssetStatusEnum.REPAIR -> "В ремонте"
                ed.maevski.hwwach.domain.models.AssetStatusEnum.DECOMMISSIONED -> "Списан"
                ed.maevski.hwwach.domain.models.AssetStatusEnum.LOST -> "Утерян"
                null -> "Не указан"
            }
